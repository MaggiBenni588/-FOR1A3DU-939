...
# 2017-01-29
# L5-FVS02-Skil01a Skilaverkfni 2
...
while svar == 'já' :
    ...
    svar = input('Viltu slá inno aðra heiltölu? (Svara með já eða nei)')
...
# 
#  **# Liður 3 - Þríhyrningur** 
# Skrifaðu forrit sem biður notanda um að slá inn heiltölu á bilinu 1 – 9. Forritið teiknar svo á skjáinn þríhyrning með hliðarlengd jafnri tölunni sem slegin er inn,
...
# 
#  **# Liður 4 - Útreikningur** 
# Skrifaðu forrit sem biður notandann um að slá inn heiltölu. Virkni forrits er síðan þannig að forritið tekur töluna sem slegin er inn segjum t.d. ef talan 4 er slegin inn og margfaldar saman rununa 4 * 3 * 2 * 1.
